...
type FlowToolImpl struct {
}

func NewFlowTool() *FlowToolImpl {
	return &FlowToolImpl{}
}

func (t *FlowToolImpl) reportImpl(arguments string) string {
...
func (t *FlowToolImpl) Report(toolCall providers.ToolCall) string {
	return t.reportImpl(toolCall.Args)
}

func (t *FlowToolImpl) waitImpl(arguments string) string {
	var args map[string]interface{}
	err := json.Unmarshal([]byte(arguments), &args)
	if err != nil {
...
func (t *FlowToolImpl) Wait(toolCall providers.ToolCall) string {
