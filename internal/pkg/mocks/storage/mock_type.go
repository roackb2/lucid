...
func (mr *MockStorageMockRecorder) GetAgentState(agentID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageMockRecorder) SaveAgentState(agentID, state interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageMockRecorder) SavePost(content interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageMockRecorder) SearchPosts(query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
